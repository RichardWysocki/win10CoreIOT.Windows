...
namespace win10Core.Business.Engine
{
    public class EmailEngine : IEmailEngine
    {
        ...
        public void Send(string userName, string sender, string subject, string body, string recipient)
        {
